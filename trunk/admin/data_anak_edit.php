<?php
	...
	require(__FORMBASE_CLASSES__ . '/DataAnakEditFormBase.class.php');
	 ...
	 * @subpackage Drafts
	 */
	class DataAnakEditForm extends DataAnakEditFormBase {
...
//		protected function Form_Create() {}
	...
	// data_anak_edit.tpl.php as the included HTML template file
	DataAnakEditForm::Run('DataAnakEditForm');
?>