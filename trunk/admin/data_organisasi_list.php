<?php
	...
	require(__FORMBASE_CLASSES__ . '/DataOrganisasiListFormBase.class.php');
	 ...
	 * @subpackage Drafts
	 */
	class DataOrganisasiListForm extends DataOrganisasiListFormBase {
...
//		protected function Form_Create() {}
	...
	// data_organisasi_list.tpl.php as the included HTML template file
	DataOrganisasiListForm::Run('DataOrganisasiListForm');
?>