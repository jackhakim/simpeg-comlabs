<?php
	...
	require(__FORMBASE_CLASSES__ . '/DataPegawaiListFormBase.class.php');
	 ...
	 * @subpackage Drafts
	 */
	class DataPegawaiListForm extends DataPegawaiListFormBase {
...
//		protected function Form_Create() {}
	...
	// data_pegawai_list.tpl.php as the included HTML template file
	DataPegawaiListForm::Run('DataPegawaiListForm');
?>