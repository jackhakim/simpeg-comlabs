<?php
	...
	require(__FORMBASE_CLASSES__ . '/DataPenghargaanEksListFormBase.class.php');
	 ...
	 * @subpackage Drafts
	 */
	class DataPenghargaanEksListForm extends DataPenghargaanEksListFormBase {
...
//		protected function Form_Create() {}
	...
	// data_penghargaan_eks_list.tpl.php as the included HTML template file
	DataPenghargaanEksListForm::Run('DataPenghargaanEksListForm');
?>