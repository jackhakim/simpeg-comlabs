<?php
	...
	require(__FORMBASE_CLASSES__ . '/DataPasanganListFormBase.class.php');
	 ...
	 * @subpackage Drafts
	 */
	class DataPasanganListForm extends DataPasanganListFormBase {
...
//		protected function Form_Create() {}
	...
	// data_pasangan_list.tpl.php as the included HTML template file
	DataPasanganListForm::Run('DataPasanganListForm');
?>