<?php
	...
	require(__FORMBASE_CLASSES__ . '/DataPenghargaanInEditFormBase.class.php');
	 ...
	 * @subpackage Drafts
	 */
	class DataPenghargaanInEditForm extends DataPenghargaanInEditFormBase {
...
//		protected function Form_Create() {}
	...
	// data_penghargaan_in_edit.tpl.php as the included HTML template file
	DataPenghargaanInEditForm::Run('DataPenghargaanInEditForm');
?>