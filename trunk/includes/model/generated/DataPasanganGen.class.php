<?php
	/**
	 * The abstract DataPasanganGen class defined here is
	 * code-generated and contains all the basic CRUD-type functionality as well as
	 * basic methods to handle relationships and index-based loading.
	 *
	 * To use, you should use the DataPasangan subclass which
	 * extends this DataPasanganGen class.
	 *
	 * Because subsequent re-code generations will overwrite any changes to this
	 * file, you should leave this file unaltered to prevent yourself from losing
	 * any information or code changes.  All customizations should be done by
	 * overriding existing or implementing new methods, properties and variables
	 * in the DataPasangan class.
	 *
	 * @package My QCubed Application
	 * @subpackage GeneratedDataObjects
	 * @property string $Nip the value for strNip (PK)
	 * @property string $NamaPasangan the value for strNamaPasangan 
	 ...
	 * @property string $PendidikanTerakhir the value for strPendidikanTerakhir 
	 * @property QDateTime $TglNikah the value for dttTglNikah 
	 * @property QDateTime $TglCerai the value for dttTglCerai 
	 * @property DataPegawai $NipObject the value for the DataPegawai object referenced by strNip (PK)
	 * @property-read boolean $__Restored whether or not this object was restored from the database (as opposed to created new)
	 */
	class DataPasanganGen extends QBaseClass implements IteratorAggregate {
		...
		/**
		 * Protected member variable that maps to the database PK column data_pasangan.nip
		 * @var string strNip
		 */
		protected $strNip;
		...
		/**
		 * Protected member variable that maps to the database column data_pasangan.nama_pasangan
		 * @var string strNamaPasangan
		 */
		protected $strNamaPasangan;
		const NamaPasanganMaxLength = 45;
		const NamaPasanganDefault = null;


		/**
		 * Protected member variable that maps to the database column data_pasangan.tempat_lahir
		...
		/**
		 * Protected member variable that maps to the database column data_pasangan.tgl_lahir
		...
		/**
		 * Protected member variable that maps to the database column data_pasangan.agama
		 * @var string strAgama
		 */
		protected $strAgama;
		...
		/**
		 * Protected member variable that maps to the database column data_pasangan.status_nikah
		...
		/**
		 * Protected member variable that maps to the database column data_pasangan.jum_tanggungan
		...
		/**
		 * Protected member variable that maps to the database column data_pasangan.alamat
		...
		/**
		 * Protected member variable that maps to the database column data_pasangan.nama_bapak
		...
		/**
		 * Protected member variable that maps to the database column data_pasangan.nama_ibu
		...
		/**
		 * Protected member variable that maps to the database column data_pasangan.pendidikan_terakhir
		 * @var string strPendidikanTerakhir
		 */
		protected $strPendidikanTerakhir;
		const PendidikanTerakhirMaxLength = 45;
		const PendidikanTerakhirDefault = null;


		/**
		 * Protected member variable that maps to the database column data_pasangan.tgl_nikah
		 * @var QDateTime dttTglNikah
		 */
		protected $dttTglNikah;
		const TglNikahDefault = null;


		/**
		 * Protected member variable that maps to the database column data_pasangan.tgl_cerai
		 * @var QDateTime dttTglCerai
		 */
		protected $dttTglCerai;
		const TglCeraiDefault = null;
		 ...
		 * in the database column data_pasangan.nip.
		 *
		...
		{
			$this->strNip = DataPasangan::NipDefault;
			$this->strNamaPasangan = DataPasangan::NamaPasanganDefault;
			$this->strTempatLahir = DataPasangan::TempatLahirDefault;
			$this->dttTglLahir = (DataPasangan::TglLahirDefault === null)?null:new QDateTime(DataPasangan::TglLahirDefault);
			$this->strAgama = DataPasangan::AgamaDefault;
			$this->strStatusNikah = DataPasangan::StatusNikahDefault;
			$this->intJumTanggungan = DataPasangan::JumTanggunganDefault;
			$this->strAlamat = DataPasangan::AlamatDefault;
			$this->strNamaBapak = DataPasangan::NamaBapakDefault;
			$this->strNamaIbu = DataPasangan::NamaIbuDefault;
			$this->strPendidikanTerakhir = DataPasangan::PendidikanTerakhirDefault;
			$this->dttTglNikah = (DataPasangan::TglNikahDefault === null)?null:new QDateTime(DataPasangan::TglNikahDefault);
			$this->dttTglCerai = (DataPasangan::TglCeraiDefault === null)?null:new QDateTime(DataPasangan::TglCeraiDefault);
		}
		...
		/**
		 * Load a DataPasangan from PK Info
		 * @param string $strNip
		...
		public static function Load($strNip, $objOptionalClauses = null) {
			...
			return DataPasangan::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::DataPasangan()->Nip, $strNip)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadAll($objOptionalClauses = null) {
			...
			// Call DataPasangan::QueryArray to perform the LoadAll query
			try {
				return DataPasangan::QueryArray(QQ::All(), $objOptionalClauses);
		...
		/**
		 * Count all DataPasangans
		 * @return int
		 */
		public static function CountAll() {
			// Call DataPasangan::QueryCount to perform the CountAll query
			return DataPasangan::QueryCount(QQ::All());
		}
		...
		protected static function BuildQueryStatement(&$objQueryBuilder, QQCondition $objConditions, $objOptionalClauses, $mixParameterArray, $blnCountOnly) {
			...
			$objDatabase = DataPasangan::GetDatabase();

			// Create/Build out the QueryBuilder object with DataPasangan-specific SELET and FROM fields
			$objQueryBuilder = new QQueryBuilder($objDatabase, 'data_pasangan');
			DataPasangan::GetSelectFields($objQueryBuilder);
			$objQueryBuilder->AddFromItem('data_pasangan');
		...
		/**
		 * Static Qcubed Query method to query for a single DataPasangan object.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return DataPasangan the queried object
		 */
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = DataPasangan::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, false);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}

			// Perform the Query, Get the First Row, and Instantiate a new DataPasangan object
			...
			if ($objQueryBuilder->ExpandAsArrayNodes) {
				...
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = DataPasangan::InstantiateDbRow($objDbRow, null, $objQueryBuilder->ExpandAsArrayNodes, $objToReturn, $objQueryBuilder->ColumnAliasArray);
					if ($objItem)
						$objToReturn[] = $objItem;
				}
				...
				if(null === $objDbRow)
					return null;
				return DataPasangan::InstantiateDbRow($objDbRow, null, null, null, $objQueryBuilder->ColumnAliasArray);
			}
		}

		/**
		 * Static Qcubed Query method to query for an array of DataPasangan objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return DataPasangan[] the queried objects as an array
		 */
		public static function QueryArray(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return DataPasangan::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNodes, $objQueryBuilder->ColumnAliasArray);
		}

		/**
		 * Static Qcubed Query method to query for a count of DataPasangan objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		...
		public static function QueryCount(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = DataPasangan::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, true);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}
		...
		public static function QueryArrayCached(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null, $blnForceUpdate = false) {
			...
			$objCache = new QCache('qquery/datapasangan', $strQuery);
			$cacheData = $objCache->GetData();

			if (!$cacheData || $blnForceUpdate) {
				$objDbResult = $objQueryBuilder->Database->Query($strQuery);
				$arrResult = DataPasangan::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNodes, $objQueryBuilder->ColumnAliasArray);
		...
		/**
		 * Updates a QQueryBuilder with the SELECT fields for this DataPasangan
		...
		public static function GetSelectFields(QQueryBuilder $objBuilder, $strPrefix = null) {
			if ($strPrefix) {
				...
				$strTableName = 'data_pasangan';
				$strAliasPrefix = '';
			}

			$objBuilder->AddSelectItem($strTableName, 'nip', $strAliasPrefix . 'nip');
			$objBuilder->AddSelectItem($strTableName, 'nama_pasangan', $strAliasPrefix . 'nama_pasangan');
			...
			$objBuilder->AddSelectItem($strTableName, 'pendidikan_terakhir', $strAliasPrefix . 'pendidikan_terakhir');
			$objBuilder->AddSelectItem($strTableName, 'tgl_nikah', $strAliasPrefix . 'tgl_nikah');
			$objBuilder->AddSelectItem($strTableName, 'tgl_cerai', $strAliasPrefix . 'tgl_cerai');
		}
		...
		/**
		 * Instantiate a DataPasangan from a Database Row.
		 * Takes in an optional strAliasPrefix, used in case another Object::InstantiateDbRow
		 * is calling this DataPasangan::InstantiateDbRow in order to perform
		...
		*/
		public static function InstantiateDbRow($objDbRow, $strAliasPrefix = null, $strExpandAsArrayNodes = null, $arrPreviousItems = null, $strColumnAliasArray = array()) {
			...
			// Create a new instance of the DataPasangan object
			$objToReturn = new DataPasangan();
			...
			$strAliasName = array_key_exists($strAliasPrefix . 'nama_pasangan', $strColumnAliasArray) ? $strColumnAliasArray[$strAliasPrefix . 'nama_pasangan'] : $strAliasPrefix . 'nama_pasangan';
			$objToReturn->strNamaPasangan = $objDbRow->GetColumn($strAliasName, 'VarChar');
			...
			$strAliasName = array_key_exists($strAliasPrefix . 'pendidikan_terakhir', $strColumnAliasArray) ? $strColumnAliasArray[$strAliasPrefix . 'pendidikan_terakhir'] : $strAliasPrefix . 'pendidikan_terakhir';
			$objToReturn->strPendidikanTerakhir = $objDbRow->GetColumn($strAliasName, 'VarChar');
			$strAliasName = array_key_exists($strAliasPrefix . 'tgl_nikah', $strColumnAliasArray) ? $strColumnAliasArray[$strAliasPrefix . 'tgl_nikah'] : $strAliasPrefix . 'tgl_nikah';
			$objToReturn->dttTglNikah = $objDbRow->GetColumn($strAliasName, 'Date');
			$strAliasName = array_key_exists($strAliasPrefix . 'tgl_cerai', $strColumnAliasArray) ? $strColumnAliasArray[$strAliasPrefix . 'tgl_cerai'] : $strAliasPrefix . 'tgl_cerai';
			$objToReturn->dttTglCerai = $objDbRow->GetColumn($strAliasName, 'Date');
			...
			if (!$strAliasPrefix)
				$strAliasPrefix = 'data_pasangan__';
		...
		/**
		 * Instantiate an array of DataPasangans from a Database Result
		...
		public static function InstantiateDbResult(QDatabaseResultBase $objDbResult, $strExpandAsArrayNodes = null, $strColumnAliasArray = null) {
			...
			if ($strExpandAsArrayNodes) {
				$objToReturn = array();
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = DataPasangan::InstantiateDbRow($objDbRow, null, $strExpandAsArrayNodes, $objToReturn, $strColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
					}
				}
				...
				while ($objDbRow = $objDbResult->GetNextRow())
					$objToReturn[] = DataPasangan::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
			}
		...
		/**
		 * Load a single DataPasangan object,
		 * by Nip Index(es)
		 * @param string $strNip
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @return DataPasangan
		*/
				...
				if ((!$this->__blnRestored) || ($blnForceInsert)) {
					...
					$objDatabase->NonQuery('
						INSERT INTO `data_pasangan` (
							...
							' . $objDatabase->SqlVariable($this->strNamaPasangan) . ',
							...
							' . $objDatabase->SqlVariable($this->strPendidikanTerakhir) . ',
							' . $objDatabase->SqlVariable($this->dttTglNikah) . ',
							' . $objDatabase->SqlVariable($this->dttTglCerai) . '
						)
					');
					...
					$objDatabase->NonQuery('
						...
						SET
							...
							`nama_pasangan` = ' . $objDatabase->SqlVariable($this->strNamaPasangan) . ',
							...
							`pendidikan_terakhir` = ' . $objDatabase->SqlVariable($this->strPendidikanTerakhir) . ',
							`tgl_nikah` = ' . $objDatabase->SqlVariable($this->dttTglNikah) . ',
							`tgl_cerai` = ' . $objDatabase->SqlVariable($this->dttTglCerai) . '
						WHERE
		...
		/**
		 * Delete this DataPasangan
		 * @return void
		 */
		public function Delete() {
			if ((is_null($this->strNip)))
				throw new QUndefinedPrimaryKeyException('Cannot delete this DataPasangan with an unset primary key.');
		...
		public static function Truncate() {
			...
			// Perform the Query
			$objDatabase->NonQuery('
				TRUNCATE `data_pasangan`');
		}

		/**
		 * Reload this DataPasangan from the database.
		 * @return void
		 */
		public function Reload() {
			// Make sure we are actually Restored from the database
			if (!$this->__blnRestored)
				throw new QCallerException('Cannot call Reload() on a new, unsaved DataPasangan object.');

			// Reload the Object
			$objReloaded = DataPasangan::Load($this->strNip);

			// Update $this's local variables to match
			$this->Nip = $objReloaded->Nip;
			$this->__strNip = $this->strNip;
			$this->strNamaPasangan = $objReloaded->strNamaPasangan;
			...
			$this->strPendidikanTerakhir = $objReloaded->strPendidikanTerakhir;
			$this->dttTglNikah = $objReloaded->dttTglNikah;
			$this->dttTglCerai = $objReloaded->dttTglCerai;
		}
		...
		public function __get($strName) {
			switch ($strName) {
				...
				case 'NamaPasangan':
					/**
					 * Gets the value for strNamaPasangan 
					 * @return string
					 */
					return $this->strNamaPasangan;
				...
				case 'PendidikanTerakhir':
					/**
					 * Gets the value for strPendidikanTerakhir 
					 * @return string
					 */
					return $this->strPendidikanTerakhir;

				case 'TglNikah':
					/**
					 * Gets the value for dttTglNikah 
					 * @return QDateTime
					 */
					return $this->dttTglNikah;

				case 'TglCerai':
					/**
					 * Gets the value for dttTglCerai 
					 * @return QDateTime
					 */
					return $this->dttTglCerai;
		...
		public function __set($strName, $mixValue) {
			switch ($strName) {
				...
				case 'NamaPasangan':
					/**
					 * Sets the value for strNamaPasangan 
					 * @param string $mixValue
					 * @return string
					 */
					try {
						return ($this->strNamaPasangan = QType::Cast($mixValue, QType::String));
					} catch (QCallerException $objExc) {
						$objExc->IncrementOffset();
						throw $objExc;
					}
				...
				case 'PendidikanTerakhir':
					/**
					 * Sets the value for strPendidikanTerakhir 
					 * @param string $mixValue
					 * @return string
					 */
					try {
						return ($this->strPendidikanTerakhir = QType::Cast($mixValue, QType::String));
					} catch (QCallerException $objExc) {
						$objExc->IncrementOffset();
						throw $objExc;
					}
				...
				case 'TglNikah':
					/**
					 * Sets the value for dttTglNikah 
					 * @param QDateTime $mixValue
					 * @return QDateTime
					 */
					try {
						return ($this->dttTglNikah = QType::Cast($mixValue, QType::DateTime));
					} catch (QCallerException $objExc) {
						$objExc->IncrementOffset();
						throw $objExc;
					}
				...
				case 'TglCerai':
					/**
					 * Sets the value for dttTglCerai 
					 * @param QDateTime $mixValue
					 * @return QDateTime
					 */
					try {
						return ($this->dttTglCerai = QType::Cast($mixValue, QType::DateTime));
					} catch (QCallerException $objExc) {
						$objExc->IncrementOffset();
						throw $objExc;
					}
				...
				case 'NipObject':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Nip))
							throw new QCallerException('Unable to set an unsaved NipObject for this DataPasangan');
		...
		public static function GetSoapComplexTypeXml() {
			$strToReturn = '<complexType name="DataPasangan"><sequence>';
			$strToReturn .= '<element name="NipObject" type="xsd1:DataPegawai"/>';
			$strToReturn .= '<element name="NamaPasangan" type="xsd:string"/>';
			...
			$strToReturn .= '<element name="PendidikanTerakhir" type="xsd:string"/>';
			$strToReturn .= '<element name="TglNikah" type="xsd:dateTime"/>';
			$strToReturn .= '<element name="TglCerai" type="xsd:dateTime"/>';
		...
		public static function AlterSoapComplexTypeArray(&$strComplexTypeArray) {
			if (!array_key_exists('DataPasangan', $strComplexTypeArray)) {
				$strComplexTypeArray['DataPasangan'] = DataPasangan::GetSoapComplexTypeXml();
		...
		public static function GetArrayFromSoapArray($objSoapArray) {
			...
			foreach ($objSoapArray as $objSoapObject)
				array_push($objArrayToReturn, DataPasangan::GetObjectFromSoapObject($objSoapObject));
		...
		public static function GetObjectFromSoapObject($objSoapObject) {
			...
			if (property_exists($objSoapObject, 'NamaPasangan'))
				$objToReturn->strNamaPasangan = $objSoapObject->NamaPasangan;
			...
			if (property_exists($objSoapObject, 'PendidikanTerakhir'))
				$objToReturn->strPendidikanTerakhir = $objSoapObject->PendidikanTerakhir;
			if (property_exists($objSoapObject, 'TglNikah'))
				$objToReturn->dttTglNikah = new QDateTime($objSoapObject->TglNikah);
			if (property_exists($objSoapObject, 'TglCerai'))
				$objToReturn->dttTglCerai = new QDateTime($objSoapObject->TglCerai);
		...
		public static function GetSoapArrayFromArray($objArray) {
			...
			foreach ($objArray as $objObject)
				array_push($objArrayToReturn, DataPasangan::GetSoapObjectFromObject($objObject, true));
		...
		public static function GetSoapObjectFromObject($objObject, $blnBindRelatedObjects) {
			...
			if ($objObject->dttTglNikah)
				$objObject->dttTglNikah = $objObject->dttTglNikah->qFormat(QDateTime::FormatSoap);
			if ($objObject->dttTglCerai)
				$objObject->dttTglCerai = $objObject->dttTglCerai->qFormat(QDateTime::FormatSoap);
			return $objObject;
		}
		...
		public function getIterator() {
			...
			$iArray['NamaPasangan'] = $this->strNamaPasangan;
			...
			$iArray['PendidikanTerakhir'] = $this->strPendidikanTerakhir;
			$iArray['TglNikah'] = $this->dttTglNikah;
			$iArray['TglCerai'] = $this->dttTglCerai;
     ...
     * @property-read QQNode $NamaPasangan
     ...
     * @property-read QQNode $PendidikanTerakhir
     * @property-read QQNode $TglNikah
     * @property-read QQNode $TglCerai
     *
     *

     * @property-read QQNodeDataPegawai $_PrimaryKeyNode
     **/
	class QQNodeDataPasangan extends QQNode {
		protected $strTableName = 'data_pasangan';
		protected $strPrimaryKey = 'nip';
		protected $strClassName = 'DataPasangan';
		public function __get($strName) {
			switch ($strName) {
				case 'Nip':
				...
				case 'NamaPasangan':
					return new QQNode('nama_pasangan', 'NamaPasangan', 'VarChar', $this);
				case 'TempatLahir':
				...
				case 'PendidikanTerakhir':
					return new QQNode('pendidikan_terakhir', 'PendidikanTerakhir', 'VarChar', $this);
				case 'TglNikah':
					return new QQNode('tgl_nikah', 'TglNikah', 'Date', $this);
				case 'TglCerai':
					return new QQNode('tgl_cerai', 'TglCerai', 'Date', $this);
     ...
     * @property-read QQNodeDataPegawai $_PrimaryKeyNode
     **/
	class QQReverseReferenceNodeDataPasangan extends QQReverseReferenceNode {
		protected $strTableName = 'data_pasangan';
		protected $strPrimaryKey = 'nip';
		protected $strClassName = 'DataPasangan';
		public function __get($strName) {
			switch ($strName) {
				...
				case 'NamaPasangan':
					return new QQNode('nama_pasangan', 'NamaPasangan', 'string', $this);
				case 'TempatLahir':
				...
				case 'PendidikanTerakhir':
					return new QQNode('pendidikan_terakhir', 'PendidikanTerakhir', 'string', $this);
				case 'TglNikah':
					return new QQNode('tgl_nikah', 'TglNikah', 'QDateTime', $this);
				case 'TglCerai':
					return new QQNode('tgl_cerai', 'TglCerai', 'QDateTime', $this);
