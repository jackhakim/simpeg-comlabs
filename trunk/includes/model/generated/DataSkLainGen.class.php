<?php
	/**
	 * The abstract DataSkLainGen class defined here is
	 * code-generated and contains all the basic CRUD-type functionality as well as
	 * basic methods to handle relationships and index-based loading.
	 *
	 * To use, you should use the DataSkLain subclass which
	 * extends this DataSkLainGen class.
	 *
	 * Because subsequent re-code generations will overwrite any changes to this
	 * file, you should leave this file unaltered to prevent yourself from losing
	 * any information or code changes.  All customizations should be done by
	 * overriding existing or implementing new methods, properties and variables
	 * in the DataSkLain class.
	 *
	 ...
	 */
	class DataSkLainGen extends QBaseClass implements IteratorAggregate {
		...
		/**
		 * Protected member variable that maps to the database PK column data_sk_lain.nip
		 * @var string strNip
		 */
		protected $strNip;
		...
		/**
		 * Protected member variable that maps to the database column data_sk_lain.no_sk
		 * @var string strNoSk
		 */
		protected $strNoSk;
		...
		/**
		 * Protected member variable that maps to the database column data_sk_lain.jenis_sk
		 * @var string strJenisSk
		 */
		protected $strJenisSk;
		const JenisSkMaxLength = 45;
		 ...
		 * in the database column data_sk_lain.nip.
		 *
		...
		{
			$this->strNip = DataSkLain::NipDefault;
			$this->strNoSk = DataSkLain::NoSkDefault;
			$this->strJenisSk = DataSkLain::JenisSkDefault;
		}
		...
		/**
		 * Load a DataSkLain from PK Info
		 * @param string $strNip
		...
		public static function Load($strNip, $objOptionalClauses = null) {
			...
			return DataSkLain::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::DataSkLain()->Nip, $strNip)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadAll($objOptionalClauses = null) {
			...
			// Call DataSkLain::QueryArray to perform the LoadAll query
			try {
				return DataSkLain::QueryArray(QQ::All(), $objOptionalClauses);
		...
		/**
		 * Count all DataSkLains
		 * @return int
		 */
		public static function CountAll() {
			// Call DataSkLain::QueryCount to perform the CountAll query
			return DataSkLain::QueryCount(QQ::All());
		}
		...
		protected static function BuildQueryStatement(&$objQueryBuilder, QQCondition $objConditions, $objOptionalClauses, $mixParameterArray, $blnCountOnly) {
			...
			$objDatabase = DataSkLain::GetDatabase();

			// Create/Build out the QueryBuilder object with DataSkLain-specific SELET and FROM fields
			$objQueryBuilder = new QQueryBuilder($objDatabase, 'data_sk_lain');
			DataSkLain::GetSelectFields($objQueryBuilder);
			$objQueryBuilder->AddFromItem('data_sk_lain');
		...
		/**
		 * Static Qcubed Query method to query for a single DataSkLain object.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return DataSkLain the queried object
		 */
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = DataSkLain::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, false);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}

			// Perform the Query, Get the First Row, and Instantiate a new DataSkLain object
			...
			if ($objQueryBuilder->ExpandAsArrayNodes) {
				...
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = DataSkLain::InstantiateDbRow($objDbRow, null, $objQueryBuilder->ExpandAsArrayNodes, $objToReturn, $objQueryBuilder->ColumnAliasArray);
					if ($objItem)
						$objToReturn[] = $objItem;
				}
				...
				if(null === $objDbRow)
					return null;
				return DataSkLain::InstantiateDbRow($objDbRow, null, null, null, $objQueryBuilder->ColumnAliasArray);
			}
		}

		/**
		 * Static Qcubed Query method to query for an array of DataSkLain objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return DataSkLain[] the queried objects as an array
		 */
		public static function QueryArray(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return DataSkLain::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNodes, $objQueryBuilder->ColumnAliasArray);
		}

		/**
		 * Static Qcubed Query method to query for a count of DataSkLain objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		...
		public static function QueryCount(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = DataSkLain::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, true);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}
		...
		public static function QueryArrayCached(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null, $blnForceUpdate = false) {
			...
			$objCache = new QCache('qquery/datasklain', $strQuery);
			$cacheData = $objCache->GetData();

			if (!$cacheData || $blnForceUpdate) {
				$objDbResult = $objQueryBuilder->Database->Query($strQuery);
				$arrResult = DataSkLain::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNodes, $objQueryBuilder->ColumnAliasArray);
		...
		/**
		 * Updates a QQueryBuilder with the SELECT fields for this DataSkLain
		...
		/**
		 * Instantiate a DataSkLain from a Database Row.
		 * Takes in an optional strAliasPrefix, used in case another Object::InstantiateDbRow
		 * is calling this DataSkLain::InstantiateDbRow in order to perform
		...
		*/
		public static function InstantiateDbRow($objDbRow, $strAliasPrefix = null, $strExpandAsArrayNodes = null, $arrPreviousItems = null, $strColumnAliasArray = array()) {
			...
			// Create a new instance of the DataSkLain object
			$objToReturn = new DataSkLain();
		...
		/**
		 * Instantiate an array of DataSkLains from a Database Result
		...
		public static function InstantiateDbResult(QDatabaseResultBase $objDbResult, $strExpandAsArrayNodes = null, $strColumnAliasArray = null) {
			...
			if ($strExpandAsArrayNodes) {
				$objToReturn = array();
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = DataSkLain::InstantiateDbRow($objDbRow, null, $strExpandAsArrayNodes, $objToReturn, $strColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
					}
				}
				...
				while ($objDbRow = $objDbResult->GetNextRow())
					$objToReturn[] = DataSkLain::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
			}
		...
		/**
		 * Load a single DataSkLain object,
		 * by Nip Index(es)
		 * @param string $strNip
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @return DataSkLain
		*/
		...
		/**
		 * Delete this DataSkLain
		 * @return void
		 */
		public function Delete() {
			if ((is_null($this->strNip)))
				throw new QUndefinedPrimaryKeyException('Cannot delete this DataSkLain with an unset primary key.');
		...
		public static function Truncate() {
			...
			// Perform the Query
			$objDatabase->NonQuery('
				TRUNCATE `data_sk_lain`');
		}

		/**
		 * Reload this DataSkLain from the database.
		 * @return void
		 */
		public function Reload() {
			// Make sure we are actually Restored from the database
			if (!$this->__blnRestored)
				throw new QCallerException('Cannot call Reload() on a new, unsaved DataSkLain object.');

			// Reload the Object
			$objReloaded = DataSkLain::Load($this->strNip);
				...
				case 'NipObject':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Nip))
							throw new QCallerException('Unable to set an unsaved NipObject for this DataSkLain');
		...
		public static function GetSoapComplexTypeXml() {
			$strToReturn = '<complexType name="DataSkLain"><sequence>';
		...
		public static function AlterSoapComplexTypeArray(&$strComplexTypeArray) {
			if (!array_key_exists('DataSkLain', $strComplexTypeArray)) {
				$strComplexTypeArray['DataSkLain'] = DataSkLain::GetSoapComplexTypeXml();
		...
		public static function GetArrayFromSoapArray($objSoapArray) {
			...
			foreach ($objSoapArray as $objSoapObject)
				array_push($objArrayToReturn, DataSkLain::GetObjectFromSoapObject($objSoapObject));
		...
		public static function GetSoapArrayFromArray($objArray) {
			...
			foreach ($objArray as $objObject)
				array_push($objArrayToReturn, DataSkLain::GetSoapObjectFromObject($objObject, true));
     ...
     **/
	class QQNodeDataSkLain extends QQNode {
		protected $strTableName = 'data_sk_lain';
		protected $strPrimaryKey = 'nip';
		protected $strClassName = 'DataSkLain';
		public function __get($strName) {
			switch ($strName) {
				case 'Nip':
     ...
     * @property-read QQNodeDataPegawai $_PrimaryKeyNode
     **/
	class QQReverseReferenceNodeDataSkLain extends QQReverseReferenceNode {
		protected $strTableName = 'data_sk_lain';
		protected $strPrimaryKey = 'nip';
		protected $strClassName = 'DataSkLain';
		public function __get($strName) {
