<?php
	 ...
	 * listing a collection of DataPenghargaanIn objects.  It includes
	 ...
	 *
	 */
	class DataPenghargaanInDataGridGen extends QDataGrid {
		 ...
		 * way of adding a column to this DataPenghargaanIn datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the DataPenghargaanIn object, or it can be any QQNode extending from QQN::DataPenghargaanIn().
		 *
		 ...
		 * sorting using two fields from the DataPenghargaanIn object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from DataPenghargaanIn
		...
		public function MetaDataBinder() {
			...
			if ($this->Paginator) {
				$this->TotalItemCount = DataPenghargaanIn::QueryCount($objConditions);
			}
			...
			// Set the DataSource to be a Query result from DataPenghargaanIn, given the clauses above
			$this->DataSource = DataPenghargaanIn::QueryArray($objConditions, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a DataPenghargaanIn-based QQNode.
		 * It will also verify that it is a proper DataPenghargaanIn-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'data_penghargaan_in') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "data_penghargaan_in".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Nip': return QQN::DataPenghargaanIn()->Nip;
				case 'NipObject': return QQN::DataPenghargaanIn()->NipObject;
				case 'JenisPenghargaan': return QQN::DataPenghargaanIn()->JenisPenghargaan;
				case 'NoSk': return QQN::DataPenghargaanIn()->NoSk;
				default: throw new QCallerException('Simple Property not found in DataPenghargaanInDataGrid content: ' . $mixContent);
