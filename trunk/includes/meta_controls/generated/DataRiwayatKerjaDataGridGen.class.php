<?php
	 ...
	 * listing a collection of DataRiwayatKerja objects.  It includes
	 ...
	 *
	 */
	class DataRiwayatKerjaDataGridGen extends QDataGrid {
		 ...
		 * way of adding a column to this DataRiwayatKerja datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the DataRiwayatKerja object, or it can be any QQNode extending from QQN::DataRiwayatKerja().
		 *
		 ...
		 * sorting using two fields from the DataRiwayatKerja object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from DataRiwayatKerja
		...
		public function MetaDataBinder() {
			...
			if ($this->Paginator) {
				$this->TotalItemCount = DataRiwayatKerja::QueryCount($objConditions);
			}
			...
			// Set the DataSource to be a Query result from DataRiwayatKerja, given the clauses above
			$this->DataSource = DataRiwayatKerja::QueryArray($objConditions, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a DataRiwayatKerja-based QQNode.
		 * It will also verify that it is a proper DataRiwayatKerja-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'data_riwayat_kerja') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "data_riwayat_kerja".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Nip': return QQN::DataRiwayatKerja()->Nip;
				case 'NipObject': return QQN::DataRiwayatKerja()->NipObject;
				case 'NoSk': return QQN::DataRiwayatKerja()->NoSk;
				case 'JenisSk': return QQN::DataRiwayatKerja()->JenisSk;
				case 'TglKeluar': return QQN::DataRiwayatKerja()->TglKeluar;
				default: throw new QCallerException('Simple Property not found in DataRiwayatKerjaDataGrid content: ' . $mixContent);
