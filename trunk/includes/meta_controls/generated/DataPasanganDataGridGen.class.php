<?php
	 ...
	 * listing a collection of DataPasangan objects.  It includes
	 ...
	 *
	 */
	class DataPasanganDataGridGen extends QDataGrid {
		 ...
		 * way of adding a column to this DataPasangan datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the DataPasangan object, or it can be any QQNode extending from QQN::DataPasangan().
		 *
		 ...
		 * sorting using two fields from the DataPasangan object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from DataPasangan
		...
		public function MetaDataBinder() {
			...
			if ($this->Paginator) {
				$this->TotalItemCount = DataPasangan::QueryCount($objConditions);
			}
			...
			// Set the DataSource to be a Query result from DataPasangan, given the clauses above
			$this->DataSource = DataPasangan::QueryArray($objConditions, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a DataPasangan-based QQNode.
		 * It will also verify that it is a proper DataPasangan-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'data_pasangan') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "data_pasangan".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Nip': return QQN::DataPasangan()->Nip;
				case 'NipObject': return QQN::DataPasangan()->NipObject;
				case 'NamaPasangan': return QQN::DataPasangan()->NamaPasangan;
				case 'TempatLahir': return QQN::DataPasangan()->TempatLahir;
				case 'TglLahir': return QQN::DataPasangan()->TglLahir;
				case 'Agama': return QQN::DataPasangan()->Agama;
				case 'StatusNikah': return QQN::DataPasangan()->StatusNikah;
				case 'JumTanggungan': return QQN::DataPasangan()->JumTanggungan;
				case 'Alamat': return QQN::DataPasangan()->Alamat;
				case 'NamaBapak': return QQN::DataPasangan()->NamaBapak;
				case 'NamaIbu': return QQN::DataPasangan()->NamaIbu;
				case 'PendidikanTerakhir': return QQN::DataPasangan()->PendidikanTerakhir;
				case 'TglNikah': return QQN::DataPasangan()->TglNikah;
				case 'TglCerai': return QQN::DataPasangan()->TglCerai;
				default: throw new QCallerException('Simple Property not found in DataPasanganDataGrid content: ' . $mixContent);
