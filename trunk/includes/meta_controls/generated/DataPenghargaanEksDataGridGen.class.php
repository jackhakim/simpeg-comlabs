<?php
	 ...
	 * listing a collection of DataPenghargaanEks objects.  It includes
	 ...
	 *
	 */
	class DataPenghargaanEksDataGridGen extends QDataGrid {
		 ...
		 * way of adding a column to this DataPenghargaanEks datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the DataPenghargaanEks object, or it can be any QQNode extending from QQN::DataPenghargaanEks().
		 *
		 ...
		 * sorting using two fields from the DataPenghargaanEks object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from DataPenghargaanEks
		...
		public function MetaDataBinder() {
			...
			if ($this->Paginator) {
				$this->TotalItemCount = DataPenghargaanEks::QueryCount($objConditions);
			}
			...
			// Set the DataSource to be a Query result from DataPenghargaanEks, given the clauses above
			$this->DataSource = DataPenghargaanEks::QueryArray($objConditions, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a DataPenghargaanEks-based QQNode.
		 * It will also verify that it is a proper DataPenghargaanEks-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'data_penghargaan_eks') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "data_penghargaan_eks".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Nip': return QQN::DataPenghargaanEks()->Nip;
				case 'NipObject': return QQN::DataPenghargaanEks()->NipObject;
				case 'NamaPenghargaan': return QQN::DataPenghargaanEks()->NamaPenghargaan;
				case 'TglDapat': return QQN::DataPenghargaanEks()->TglDapat;
				case 'Pemberi': return QQN::DataPenghargaanEks()->Pemberi;
				case 'Alamat': return QQN::DataPenghargaanEks()->Alamat;
				default: throw new QCallerException('Simple Property not found in DataPenghargaanEksDataGrid content: ' . $mixContent);
