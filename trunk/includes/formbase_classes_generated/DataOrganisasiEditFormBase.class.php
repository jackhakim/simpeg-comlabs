<?php
	 ...
	 */
	abstract class DataOrganisasiEditFormBase extends QForm {
		// Local instance of the DataOrganisasiMetaControl
		/**
		 * @var DataOrganisasiMetaControlGen mctDataOrganisasi
		 */
...
//		protected function Form_PreRender() {}
		...
		protected function Form_Create() {
			...
			// Use the CreateFromPathInfo shortcut (this can also be done manually using the DataOrganisasiMetaControl constructor)
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctDataOrganisasi = DataOrganisasiMetaControl::CreateFromPathInfo($this);
		...
		protected function RedirectToListPage() {
			QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__ . '/data_organisasi_list.php');
		}
	}
?>
