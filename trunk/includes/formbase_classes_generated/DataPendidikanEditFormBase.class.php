<?php
	 ...
	 */
	abstract class DataPendidikanEditFormBase extends QForm {
		// Local instance of the DataPendidikanMetaControl
		/**
		 * @var DataPendidikanMetaControlGen mctDataPendidikan
		 */
...
//		protected function Form_PreRender() {}
		...
		protected function Form_Create() {
			...
			// Use the CreateFromPathInfo shortcut (this can also be done manually using the DataPendidikanMetaControl constructor)
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctDataPendidikan = DataPendidikanMetaControl::CreateFromPathInfo($this);
		...
		protected function RedirectToListPage() {
			QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__ . '/data_pendidikan_list.php');
		}
	}
?>
