<?php
	 ...
	 */
	abstract class DataPenghargaanInEditFormBase extends QForm {
		// Local instance of the DataPenghargaanInMetaControl
		/**
		 * @var DataPenghargaanInMetaControlGen mctDataPenghargaanIn
		 */
...
//		protected function Form_PreRender() {}
		...
		protected function Form_Create() {
			...
			// Use the CreateFromPathInfo shortcut (this can also be done manually using the DataPenghargaanInMetaControl constructor)
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctDataPenghargaanIn = DataPenghargaanInMetaControl::CreateFromPathInfo($this);
		...
		protected function RedirectToListPage() {
			QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__ . '/data_penghargaan_in_list.php');
		}
	}
?>
