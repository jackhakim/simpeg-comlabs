<?php
	...
	require(__FORMBASE_CLASSES__ . '/DataRiwayatKerjaListFormBase.class.php');
	 ...
	 * @subpackage Drafts
	 */
	class DataRiwayatKerjaListForm extends DataRiwayatKerjaListFormBase {
...
//		protected function Form_Create() {}
	...
	// data_riwayat_kerja_list.tpl.php as the included HTML template file
	DataRiwayatKerjaListForm::Run('DataRiwayatKerjaListForm');
?>