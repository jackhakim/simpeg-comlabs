<?php
	...
	require(__FORMBASE_CLASSES__ . '/DataOrganisasiEditFormBase.class.php');
	 ...
	 * @subpackage Drafts
	 */
	class DataOrganisasiEditForm extends DataOrganisasiEditFormBase {
...
//		protected function Form_Create() {}
	...
	// data_organisasi_edit.tpl.php as the included HTML template file
	DataOrganisasiEditForm::Run('DataOrganisasiEditForm');
?>