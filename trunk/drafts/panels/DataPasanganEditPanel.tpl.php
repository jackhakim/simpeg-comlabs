<?php
	// This is the HTML template include file (.tpl.php) for data_pasanganEditPanel.
...
?>
	<div id="formControls">
		...
		<?php $_CONTROL->txtNamaPasangan->RenderWithName(); ?>
		...
		<?php $_CONTROL->txtPendidikanTerakhir->RenderWithName(); ?>

		<?php $_CONTROL->calTglNikah->RenderWithName(); ?>

		<?php $_CONTROL->calTglCerai->RenderWithName(); ?>
