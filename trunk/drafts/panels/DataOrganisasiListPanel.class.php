<?php
	 ...
	 * list a collection of DataOrganisasi objects.  It includes
	 * functionality to perform pagination and sorting on columns.
	 *
	 * To take advantage of some (or all) of these control objects, you
	 * must create a new QPanel which extends this DataOrganisasiListPanelBase
	 * class.
	 *
	 ...
	 *
	 */
	class DataOrganisasiListPanel extends QPanel {
		// Local instance of the Meta DataGrid to list DataOrganisasis
		/**
		 * @var DataOrganisasiDataGrid
		 */
		public $dtgDataOrganisasis;
		...
		public function __construct($objParentObject, $strSetEditPanelMethod, $strCloseEditPanelMethod, $strControlId = null) {
			...
			// Setup the Template
			$this->Template = __DOCROOT__ . __PANEL_DRAFTS__ . '/DataOrganisasiListPanel.tpl.php';
			...
			$this->dtgDataOrganisasis->ItemsPerPage = 8;
			...
			$this->dtgDataOrganisasis->MetaAddEditProxyColumn($this->pxyEdit, 'Edit', 'Edit');
			...
			$this->btnCreateNew->Text = QApplication::Translate('Create a New') . ' ' . QApplication::Translate('DataOrganisasi');
			$this->btnCreateNew->AddAction(new QClickEvent(), new QAjaxControlAction($this, 'btnCreateNew_Click'));
		}

		public function pxyEdit_Click($strFormId, $strControlId, $strParameter) {
			$strParameterArray = explode(',', $strParameter);
			$objEditPanel = new DataOrganisasiEditPanel($this, $this->strCloseEditPanelMethod, $strParameterArray[0]);
		...
		public function btnCreateNew_Click($strFormId, $strControlId, $strParameter) {
			$objEditPanel = new DataOrganisasiEditPanel($this, $this->strCloseEditPanelMethod, null);
			$strMethodName = $this->strSetEditPanelMethod;
			$this->objForm->$strMethodName($objEditPanel);
		}
	}
