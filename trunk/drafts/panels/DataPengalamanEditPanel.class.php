<?php
	...
	class DataPengalamanEditPanel extends QPanel {
		...
		public function __construct($objParentObject, $strClosePanelMethod, $strNip = null, $strControlId = null) {
			...
			$this->strTemplate = __DOCROOT__ . __PANEL_DRAFTS__ . '/DataPengalamanEditPanel.tpl.php';
			$this->strClosePanelMethod = $strClosePanelMethod;

			// Construct the DataPengalamanMetaControl
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctDataPengalaman = DataPengalamanMetaControl::Create($this, $strNip);
