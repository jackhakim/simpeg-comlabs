<?php
	 ...
	 * @subpackage Drafts
	 */
	class DataDevMandiriEditPanel extends QPanel {
		// Local instance of the DataDevMandiriMetaControl
		/**
		 * @var DataDevMandiriMetaControl
		 */
		protected $mctDataDevMandiri;

		// Controls for DataDevMandiri's Data Fields
		public $lstNipObject;
		public $txtNamaKursus;
		public $txtJenisKursus;
		public $txtPenyelenggara;
		public $txtAlamat;
		public $calTglMulai;
		public $calTglSelesai;
		public $txtNoSertifikat;
		public $txtPredikat;
		...
		public function __construct($objParentObject, $strClosePanelMethod, $strNip = null, $strControlId = null) {
			...
			$this->strTemplate = __DOCROOT__ . __PANEL_DRAFTS__ . '/DataDevMandiriEditPanel.tpl.php';
			$this->strClosePanelMethod = $strClosePanelMethod;

			// Construct the DataDevMandiriMetaControl
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctDataDevMandiri = DataDevMandiriMetaControl::Create($this, $strNip);
