<?php
	...
	require(__FORMBASE_CLASSES__ . '/DataDevMandiriListFormBase.class.php');
	 ...
	 * @subpackage Drafts
	 */
	class DataDevMandiriListForm extends DataDevMandiriListFormBase {
...
//		protected function Form_Create() {}
	...
	// data_dev_mandiri_list.tpl.php as the included HTML template file
	DataDevMandiriListForm::Run('DataDevMandiriListForm');
?>