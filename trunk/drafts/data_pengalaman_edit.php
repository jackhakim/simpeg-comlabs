<?php
	...
	require(__FORMBASE_CLASSES__ . '/DataPengalamanEditFormBase.class.php');
	 ...
	 * @subpackage Drafts
	 */
	class DataPengalamanEditForm extends DataPengalamanEditFormBase {
...
//		protected function Form_Create() {}
	...
	// data_pengalaman_edit.tpl.php as the included HTML template file
	DataPengalamanEditForm::Run('DataPengalamanEditForm');
?>